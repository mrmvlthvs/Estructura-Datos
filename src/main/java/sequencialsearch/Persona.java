...
public class Persona {
    ...
    public Persona(String nombre, String numControl, String fecha, double peso, 
                    double estatura){
        this.nombre = nombre;
        this.numControl = numControl;
    ...
    public boolean setNControl(String numControl){
        ...
        int primerosDos = Integer.parseInt(numControl.substring(0,
                            2));

        if(primerosDos < 18 || primerosDos > 25) return false;
        this.numControl = numControl;
        return true;
    }
